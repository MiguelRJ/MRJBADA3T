...
CREATE TABLE `clientes` (
  `dni` varchar(4) COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `nombre` varchar(10) COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `apellido` varchar(25) COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `ciudad` varchar(15) COLLATE utf8_general_ci NOT NULL DEFAULT '',
  PRIMARY KEY (`dni`),
  KEY `dni` (`dni`)
...
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `coches` (
  `codcoche` varchar(3) COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `cifm` varchar(4) COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `nombre` varchar(15) COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `modelo` varchar(15) COLLATE utf8_general_ci NOT NULL DEFAULT '',
...
CREATE TABLE `concesionario` (
  `cifc` varchar(4) COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `nombre` varchar(4) COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `ciudad` varchar(15) COLLATE utf8_general_ci NOT NULL DEFAULT '',
  PRIMARY KEY (`cifc`),
  KEY `cifc` (`cifc`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `ventas` (
  ...
  `dni` varchar(4) COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `codcoche` varchar(3) COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `color` varchar(15) COLLATE utf8_general_ci NOT NULL DEFAULT '',
